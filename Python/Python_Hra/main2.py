...
import math
import menu
from var import size,screen,width,height
pygame.init()
...
while True:
    ...
    if Sloup2.position.x<=0:
        ...
        Sloup1=Sloup2
        Sloup2=Sloup()
        Sloup2.final=Sloup2.surface.get_rect(topleft=(random.randint(Sloup1.surface.get_width()+10,width-(width-(screen.get_height()-150))),screen.get_height() - Sloup2.surface.get_height()))
        jedeme=True
